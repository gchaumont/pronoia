<template>
    <form method="get" @submit.prevent="" @search="performSearch">
        <div class=" w-full max-w-xs lg:max-w-md">
            ...
            <div class="relative text-gray-400  focus-within:text-gray-700">
                ...
                <input id="search-inut" class="block w-full transition-colors rounded-md border border-transparent bg-white bg-opacity-10 py-2 pl-10 pr-3 leading-5   placeholder-gray-400 focus:border-transparent focus:bg-opacity-100 focus:text-gray-900 focus:placeholder-gray-500 focus:outline-none focus:ring-0 sm:text-sm" placeholder="Search" type="search" name="search" v-model="search.state.query" autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false" enterKeyHint="search" autofocus/>
